...
const Section1 = () => {
   return (
      <div className="section1">
         <div className="section-content justify-end">
            <div className="section1-head1 head1">
               <span>
            ...
            <div className="content1">
               <div className="section1-head2 head2">Introducing an extensible editor</div>
            ...
            <div className="content2">
               <div className="section1-head2 head2">Robust content management</div>
         ...
         <div className="editor no-cursor">
         </div>
      </div>
   )
}
